...
function UserAddAddress() {
    const  [alias,setAlias,details,setDetails,phone,setPhone,onSubmit] = UserAddAddressHook()
    return (
        <div>
            ...
            <Row>
                <Col sm="8" className="d-flex justify-content-end ">
                    <button className="my-btn bg-dark h-100 text-white mt-2" onClick={onSubmit}>اضافة عنوان</button>
                </Col>
            </Row>
            <ToastContainer/>
        </div>
